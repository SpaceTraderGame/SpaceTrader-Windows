...
namespace Fryz.Apps.SpaceTrader
{
	public class FormEquipment : System.Windows.Forms.Form
	{
		...
		private void InitializeComponent()
		{
			...
			this.lstSellGadget.Location = new System.Drawing.Point(8, 216);
		...
		private void UpdateInfo()
		{
			...
			else
			{
				...
				lblDescription.Text		= Strings.EquipmentDescriptions[(int)selectedEquipment.EquipmentType][(int)selectedEquipment.SubType];
